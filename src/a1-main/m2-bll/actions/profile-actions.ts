...
export enum PROFILE_ACTIONS_TYPE {
  SET_USER_DATA = 'PlayingCards/profile/SET-USER-DATA',
  UPDATE_USER_DATA = 'PlayingCards/profile/UPDATE-USER-DATA',
  DELETE_USER_DATA = 'PlayingCards/profile/DELETE_USER_DATA',
}
